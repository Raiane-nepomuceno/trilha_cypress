...
describe('Casos de teste sobre a rota /produtos da API Serverst',() =>{
    ...
    it.only('Deve postar um novo produto com sucesso',() =>{
            Serverest.cadastrarProdutoComSucesso().then(res =>{
                ValidaServerest.validarCadastroProdutoComSucesso(res)
            })
